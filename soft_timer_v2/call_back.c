...
void cb_A(void *arg){
    ...
    long ttt = ((long)tv.tv_sec-tv_start_)*1000 + ((long)tv.tv_usec-tv_start_u)/1000;
    printf("[A] one-shot 100ms fired at  %ld ms\n", ttt);
...
void cb_B(void *arg){
    ...
    //     (long)tv.tv_sec-tv_start_, (long)tv.tv_usec-tv_start_u);
    long ttt = ((long)tv.tv_sec-tv_start_)*1000 + ((long)tv.tv_usec-tv_start_u)/1000;
    printf("[B] periodic 250ms fired at  %ld ms\n", ttt);
}
void cb_C(void *arg){
    struct timeval tv;
    gettimeofday(&tv, NULL);
    ...
    long ttt = ((long)tv.tv_sec-tv_start_)*1000 + ((long)tv.tv_usec-tv_start_u)/1000;
    printf("[C] periodic 700ms fired at %ld ms\n", ttt);
